...
//test ability to add multiple items to cart
...
//test ability to remove items from cart
...
//test to update cart quantities
...
//test to see visibility toggling of cart
test('TOGGLE_CART', () => {
    let newState = reducer(initialState, {
        type: TOGGLE_CART
    });
